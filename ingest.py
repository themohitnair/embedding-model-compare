...
MODELS = {
    "mpnet": {"name": "all-mpnet-base-v2", "dim": 768},
    "minilm": {"name": "all-MiniLM-L6-v2", "dim": 384},
    "e5_large": {"name": "intfloat/e5-large-v2", "dim": 1024},
    "e5_base": {"name": "intfloat/e5-base-v2", "dim": 768},
    "bge_large": {"name": "BAAI/bge-large-en-v1.5", "dim": 1024},
    "bge_base": {"name": "BAAI/bge-base-en-v1.5", "dim": 768},
    "gtr_t5": {"name": "sentence-transformers/gtr-t5-large", "dim": 768},
}
        ...
        for line_num, line in enumerate(f):
            try:
                ...
                for model_key, model in models.items():
                    embedding = model.encode(post_content).tolist()
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 2:
        print("Usage: python ingest_multi.py <json_file_path>")
        sys.exit(1)
